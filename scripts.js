...
function getPrediction(){  
	var nbOfFontunes = allPredictions.length;
	var predictNo = getRandomInt(nbOfFontunes);
	return allPredictions[predictNo];
}


var allPredictions = ["The early bird gets the worm, but the second mouse gets the cheese.",
